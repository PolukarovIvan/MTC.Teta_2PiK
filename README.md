...
###Деградация модели и демо-версия
 ...
 ### Итог
Наша модель имеет высокие показатели качества и  интерпретируемости, что позволяет банку оптимизировать процедуру принятия решения выдачи персональных кредитных предложений, а так же легка в использовании для неподготовленного пользователя.
